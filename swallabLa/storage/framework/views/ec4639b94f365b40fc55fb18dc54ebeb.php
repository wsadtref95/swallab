...
<body>
    ...
    <img id="aa" class="custom-size"
        src="<?php echo e(asset('images/products/pngtree-yellow-donut-illustration-png-image_4576523.jpg')); ?>" alt="">
    ...
    <div id="cola">可樂</div>
    <img id="bb" class="custom-size" src="<?php echo e(asset('images/products/下載.jpg')); ?>" alt="">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\swallabLa\resources\views/products.blade.php ENDPATH**/ ?>