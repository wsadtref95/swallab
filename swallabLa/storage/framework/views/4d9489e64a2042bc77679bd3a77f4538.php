...
<section>
   <header>
       ...
       <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
           <?php echo e(__("上傳你的大頭貼")); ?>

       </p>
   </header>


   <img src="<?php echo e($user->image); ?>" class="rounded-lg profilephoto">
...
<?php /**PATH C:\xampp\htdocs\projj\resources\views/profile/partials/update-image-form.blade.php ENDPATH**/ ?>