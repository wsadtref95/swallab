<section class="space-y-6">
    <header>
        ...
        <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
            <?php echo e(__('一旦您的帳戶被刪除，其所有資源和資料將永久刪除。在刪除您的帳戶之前，請下載您希望保留的任何資料或資訊。')); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['x-data' => '','x-on:click.prevent' => '$dispatch(\'open-modal\', \'confirm-user-deletion\')']); ?><?php echo e(__('刪除帳戶')); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php /**PATH C:\xampp\htdocs\projj\resources\views/profile/partials/delete-user-form.blade.php ENDPATH**/ ?>