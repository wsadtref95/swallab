            ...
            <div class="collapse navbar-collapse" id="navbarNavDropdown">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        ...
                        @else
                        <button class="btn btn-primary"> <a style="text-decoration: none; color:white" href="{{ route('login') }}"> <!-- 改html -->
                                登入
                            </a></button>


                        @if (Route::has('register'))
                        <button class="btn btn-primary"><a style="text-decoration: none; color:white" href="{{ route('register') }}" class="">
                                <!-- 改html -->
                                註冊
                            </a></button>
                        @endif
