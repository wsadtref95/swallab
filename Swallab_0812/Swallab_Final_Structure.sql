...
CREATE TABLE `MemberCreditCards` (
  ...
  `expiry_mm` int(11) NOT NULL,
  `expiry_yyyy` int(11) NOT NULL,
  `cvn` varchar(255) NOT NULL,
  `created_at_date` date NOT NULL DEFAULT '2024-08-16',
  `created_at_time` time NOT NULL DEFAULT '10:39:29',
...
CREATE TABLE `MemberNotes` (
  ...
  `visited_at_date` varchar(255) NOT NULL,
  `visited_at_time` varchar(255) NOT NULL,
...
CREATE TABLE `MemberReviews` (
  ...
  `created_at_date` date NOT NULL DEFAULT '2024-08-16',
  `created_at_time` time NOT NULL DEFAULT '10:39:30',
  `updated_at_date` date DEFAULT NULL,
  `updated_at_time` time DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
...
CREATE TABLE `OrderDetails` (
  ...
  `created_at_date` date NOT NULL DEFAULT '2024-08-16',
  `created_at_time` time NOT NULL DEFAULT '10:39:31',
  `updated_at_date` date DEFAULT NULL,
  `updated_at_time` time DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
...
CREATE TABLE `RestDiscount` (
  ...
  `start_time` varchar(255) NOT NULL DEFAULT '2024-08-16 10:39:30',
...
-- Dump completed on 2024-08-16 10:40:13
